  ...
  return <main id="main">
    ...
    <section className="hero-v2">
      <div className="container hero-grid">
        ...
        <Reveal className="hero-portrait-wrap">
          <ResponsiveImage name="founder-portrait" alt="Yanio Concepción Jr. in a studio portrait" width={1066} height={1600} priority />
      ...
      <div className="container">
        ...
        <Stagger className="ecosystem-grid">
          <Link className="venture-panel venture-homw" href="/ecosystem#homw">
            ...
            <ResponsiveImage name="homw-hero" alt="HOMW interactive real estate development visualization" width={1935} height={812} />
          </Link>
          <Link className="venture-panel venture-lock" href="/ecosystem#lock-city">
            <ResponsiveImage name="lock-main" alt="Lock City fashion campaign" width={1080} height={1920} />
      ...
      <div className="container">
        ...
        <article className="work-story homw-story">
          ...
          <div className="homw-gallery">
            <Reveal className="gallery-main"><ResponsiveImage name="homw-overview" alt="HOMW three-dimensional development overview" width={3439} height={1439} /></Reveal>
            <Reveal className="gallery-ui"><ResponsiveImage name="homw-explore" alt="HOMW property exploration interface" width={2185} height={1302} /></Reveal>
            <Reveal className="gallery-detail"><ResponsiveImage name="homw-unit" alt="HOMW unit selection interface" width={2184} height={1302} /></Reveal>
          </div>
        </article>
        <article className="work-story lock-story">
          ...
          <div className="lock-gallery"><Reveal><ResponsiveImage name="lock-main" alt="Lock City campaign portrait" width={1080} height={1920} /></Reveal><Reveal><ResponsiveImage name="lock-bag" alt="Lock City lock-shaped bag" width={1024} height={1536} /></Reveal><Reveal className="lock-process"><ResponsiveImage name="lock-process" alt="Lock City product and creative process" width={4032} height={3024} /></Reveal></div>
        </article>
      </div>
    </section>
    ...
    <section className="section advantage-section">
      <div className="container"><Reveal><span className="kicker light-text">03 · Founder Advantage</span></Reveal><div className="advantage-frame">
        <ResponsiveImage name="founder-advantage" alt="Yanio Concepción Jr. directing a studio production" width={5120} height={3258} />
