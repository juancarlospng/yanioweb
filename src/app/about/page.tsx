...
export default function Page() {
  return <main id="main">
    ...
    <section className="section"><div className="container about-page-grid"><ResponsiveImage name="founder-editorial" alt="Yanio Concepción Jr. in an editorial portrait" width={5120} height={3414} treatment="cinematic" fullBleed /><div><span className="kicker">Perspective</span><h2 className="editorial-title">Clarity before scale.</h2><p className="large-copy">His work connects product thinking, creative direction and long-term business architecture.</p><p>Each venture is given its own identity and commercial purpose while contributing capabilities, intelligence or cultural relevance to the wider ecosystem.</p><p>Based in Switzerland with a global outlook, Yanio builds with a focus on coherence, patient execution and relationships shaped by alignment.</p><Link className="btn primary" href="/#opportunity">Discuss an Opportunity ↗</Link></div></div></section>
