...
export default async function Page({ params }: { params: Promise<{ project: string }> }) {
  ...
  return <main id="main" className={`case-page case-${project.slug}`}>
    ...
    <section className="case-cover">{homw ? <ResponsiveImage name="homw-overview" alt="HOMW real estate development overview" width={3439} height={1439} priority /> : <div className="case-lock-cover"><ResponsiveImage name="lock-main" alt="Lock City campaign portrait" width={1080} height={1920} priority /><ResponsiveImage name="lock-bag" alt="Lock City lock-shaped bag" width={1024} height={1536} /></div>}</section>
    ...
    <section className="case-gallery container">{homw ? <><ResponsiveImage name="homw-explore" alt="HOMW exploration interface" width={2185} height={1302} /><ResponsiveImage name="homw-unit" alt="HOMW unit selection interface" width={2184} height={1302} /></> : <><ResponsiveImage name="lock-process" alt="Lock City product and creative process" width={4032} height={3024} /><ResponsiveImage name="lock-main" alt="Lock City campaign" width={1080} height={1920} /></>}</section>
